...
💼 Aspiring **Software Engineer** focused on building scalable backend systems
...
- Interested in contributing to **open source** and collaborating on real-world codebases
- Open to **freelance opportunities** where I can help solve practical problems through code
- Strong believer in **problem-solving first, tools second**
- Enjoy debugging, optimizing, and improving existing systems as much as building new ones
